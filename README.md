...
**MATERIA: Arquitetura e Organização De Computadores**
 ...
 2 - Uma fábrica de camisetas produz os 
 tamanhos pequeno, médio e grande, cada uma 
 sendo vendida respectivamente por 10, 12 e 15
 reais. Construa um algoritmo em que o usuário
 forneça a quantidade de camisetas pequenas, 
 médias e grandes referentes a uma venda, 
 e a máquina informe quanto será o valor
 arrecadado.
 ...
 9 - Fazer um algoritmo que leia 2 números inteiros e exiba a divisão destes. Sabe-se que o 2º número não pode ser zero, portanto, deve-se insistir na solicitação do 2º número até ele ser diferente de 0.
